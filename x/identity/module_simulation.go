...
const (
	...
	opWeightMsgRequestJoinTeam = "op_weight_msg_request_join_team"
	// TODO: Determine the simulation weight value
	defaultWeightMsgRequestJoinTeam int = 100

	opWeightMsgManageJoinTeamRequest = "op_weight_msg_manage_join_team_request"
	// TODO: Determine the simulation weight value
	...
	opWeightMsgManageJoinTeamInvite = "op_weight_msg_manage_join_team_invite"
	// TODO: Determine the simulation weight value
	defaultWeightMsgManageJoinTeamInvite int = 100
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	var weightMsgRequestJoinTeam int
	simState.AppParams.GetOrGenerate(simState.Cdc, opWeightMsgRequestJoinTeam, &weightMsgRequestJoinTeam, nil,
		func(_ *rand.Rand) {
			weightMsgRequestJoinTeam = defaultWeightMsgRequestJoinTeam
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgRequestJoinTeam,
		identitysimulation.SimulateMsgRequestJoinTeam(am.accountKeeper, am.bankKeeper, am.keeper),
	))

	var weightMsgManageJoinTeamRequest int
	simState.AppParams.GetOrGenerate(simState.Cdc, opWeightMsgManageJoinTeamRequest, &weightMsgManageJoinTeamRequest, nil,
		func(_ *rand.Rand) {
			weightMsgManageJoinTeamRequest = defaultWeightMsgManageJoinTeamRequest
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
	...
	var weightMsgManageJoinTeamInvite int
	simState.AppParams.GetOrGenerate(simState.Cdc, opWeightMsgManageJoinTeamInvite, &weightMsgManageJoinTeamInvite, nil,
		func(_ *rand.Rand) {
			weightMsgManageJoinTeamInvite = defaultWeightMsgManageJoinTeamInvite
		},
	)
	operations = append(operations, simulation.NewWeightedOperation(
		weightMsgManageJoinTeamInvite,
		identitysimulation.SimulateMsgManageJoinTeamInvite(am.accountKeeper, am.bankKeeper, am.keeper),
	))

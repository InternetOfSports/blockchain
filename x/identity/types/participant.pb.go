...
type Participant struct {
	...
	TeamJoiningInvites []string `protobuf:"bytes,4,rep,name=teamJoiningInvites,proto3" json:"teamJoiningInvites,omitempty"`
}
...
func (m *Participant) GetTeamJoiningInvites() []string {
	if m != nil {
...
var fileDescriptor_3e7c2e9195f7d5d2 = []byte{
	...
	,
}
...
func (m *Participant) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TeamJoiningInvites) > 0 {
		for iNdEx := len(m.TeamJoiningInvites) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TeamJoiningInvites[iNdEx])
			copy(dAtA[i:], m.TeamJoiningInvites[iNdEx])
			i = encodeVarintParticipant(dAtA, i, uint64(len(m.TeamJoiningInvites[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
...
func (m *Participant) Size() (n int) {
	...
	if len(m.TeamJoiningInvites) > 0 {
		for _, s := range m.TeamJoiningInvites {
			l = len(s)
			n += 1 + l + sovParticipant(uint64(l))
		}
	}
...
func (m *Participant) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.TeamJoiningInvites = append(m.TeamJoiningInvites, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex

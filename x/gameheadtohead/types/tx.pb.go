...
// source: blockchain/gameheadtohead/tx.proto
...
type MsgCreateGame struct {
	...
	TeamHome string `protobuf:"bytes,2,opt,name=teamHome,proto3" json:"teamHome,omitempty"`
	TeamAway string `protobuf:"bytes,3,opt,name=teamAway,proto3" json:"teamAway,omitempty"`
}
...
func (*MsgCreateGame) Descriptor() ([]byte, []int) {
	return fileDescriptor_425b474c03f89525, []int{0}
}
...
func (m *MsgCreateGame) GetTeamHome() string {
	if m != nil {
		return m.TeamHome
	}
	return ""
...
func (m *MsgCreateGame) GetTeamAway() string {
	if m != nil {
		return m.TeamAway
	}
	return ""
...
func (*MsgCreateGameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_425b474c03f89525, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgCreateGame)(nil), "internetofsports.blockchain.gameheadtohead.MsgCreateGame")
	proto.RegisterType((*MsgCreateGameResponse)(nil), "internetofsports.blockchain.gameheadtohead.MsgCreateGameResponse")
}

func init() {
	proto.RegisterFile("blockchain/gameheadtohead/tx.proto", fileDescriptor_425b474c03f89525)
}

var fileDescriptor_425b474c03f89525 = []byte{
	// 255 bytes of a gzipped FileDescriptorProto
	,
	...
	0x92, 0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0xef, 0x09, 0xb5, 0xc6, 0x3f, 0x2d, 0x18, 0x6c,
	0x8d, 0x3e, 0x52, 0xb4, 0x54, 0x60, 0x44, 0x4c, 0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0x38, 0x72,
	0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xef, 0xd4, 0x7a, 0xd5, 0xc2, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) CreateGame(ctx context.Context, in *MsgCreateGame, opts ...grpc.CallOption) (*MsgCreateGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/internetofsports.blockchain.gameheadtohead.Msg/CreateGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateGame_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/internetofsports.blockchain.gameheadtohead.Msg/CreateGame",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "internetofsports.blockchain.gameheadtohead.Msg",
	...
	Metadata: "blockchain/gameheadtohead/tx.proto",
}
...
func (m *MsgCreateGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TeamAway) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.TeamAway)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.TeamHome) > 0 {
		...
		i = encodeVarintTx(dAtA, i, uint64(len(m.TeamHome)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Creator) > 0 {
